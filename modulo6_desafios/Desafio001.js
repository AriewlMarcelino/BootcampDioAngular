...
const nomeRestaurante1 = gets('MacDonalds');
const tempoEstimadoEntrega = parseInt(gets(10));
...
console.log(`O restaurante ${nomeRestaurante1} entrega em ${tempoEstimadoEntrega} minutos.`)
